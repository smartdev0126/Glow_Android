...
public class AndExoPlayerView extends LinearLayout implements View.OnClickListener {
    ...
    private EnumLoop currLoop = EnumLoop.UNDEFINE;
    ...
    public int getVideoWidth() {
        return simpleExoPlayer != null && simpleExoPlayer.getVideoFormat() != null ? simpleExoPlayer.getVideoFormat().width : 0;
    }

    public int getVideoHeight() {
        return simpleExoPlayer != null && simpleExoPlayer.getVideoFormat() != null ? simpleExoPlayer.getVideoFormat().height : 0;
    }

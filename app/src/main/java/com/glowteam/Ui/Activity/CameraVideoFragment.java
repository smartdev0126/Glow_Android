...
import com.glowteam.Utils.AutoFitTextureView;
...
public abstract class CameraVideoFragment extends Activity {
    ...
    private CameraDevice.StateCallback mStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onError(@NonNull CameraDevice cameraDevice, int error) {
            ...
            cameraDevice.close();
            mCameraDevice = null;
            Activity activity = CameraVideoFragment.this;
            if (null != activity) {
                activity.finish();
            }
        }
...
//        setContentView(R.layout.activity_video_record);
    ...
    private void setUpMediaRecorder() throws IOException {
        ...
        CamcorderProfile profile = CamcorderProfile.get(QUALITY_HIGH_SPEED_HIGH);
        mMediaRecorder.setVideoFrameRate(480);
...
//
//                mMediaRecorder.setProfile(CamcorderProfile.get(QUALITY_HIGH_SPEED_HIGH));
//        mMediaRecorder.setOutputFile(mCurrentFile.getAbsolutePath());

...
import static com.glowteam.Ui.Activity.EditProfileActivity.skincare;
...
public class SkincareAdapter extends RecyclerView.Adapter<SkincareAdapter.ViewHolder> {
    ...
    public SkincareAdapter(EditProfileActivity editProfileActivity, String[] hairColorName) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (skincare.contains(hairColorName[holder.getAdapterPosition()])) {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (skincare.contains(hairColorName[getAdapterPosition()])) {
                        skincare.remove(hairColorName[getAdapterPosition()]);
                    } else {
                        skincare.add(hairColorName[getAdapterPosition()]);
                    }
